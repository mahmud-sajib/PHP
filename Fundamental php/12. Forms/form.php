...
2. The stripslashes() function removes backslashes

3. The htmlspecialchars() function converts some predefined characters to HTML entities

    a) & (ampersand) becomes &amp;
    b) " "(double quote) becomes &quot;
    c) < (less than) becomes &lt;
    d) > (greater than) becomes &gt;
