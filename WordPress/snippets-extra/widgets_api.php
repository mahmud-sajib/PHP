...
1. Write a class that exends form WP_Widget

2. Write Four functions:

	a) __construct() - used to register widget with WordPress
	b) widget($args,$instance) - used to display widget contents in the front end
	c) form($instance) - used to create form fields for the widget
	d) update($new_instance,$old_instance) - used to override the old values with new values

3. Register the widget with - register_widget('widgetName') function

4. Finally call add_action('widgets_init','callback') hook to turn it into action
