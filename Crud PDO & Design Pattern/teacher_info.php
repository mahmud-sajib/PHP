...
<section class="mainright">
  <table class="tblone">
    ...
    <tr>
        ...
        <?php echo "<a href='teacher_info.php?action=edit&id=".$value['id']."'>Edit</a>"; ?> ||
        <?php echo "<a href='teacher_info.php?action=delete&id=".$value['id']."' onClick='return confirm(\"Sure?\")' >Delete </a>"; ?>
